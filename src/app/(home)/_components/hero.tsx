...
export default function Hero() {
  return (
    <section className="relatvie flex min-h-[42rem] flex-col items-center bg-[#d3ccbc] px-cont-sm pt-32 text-center text-main md:bg-transparent md:px-cont-md lg:px-cont-lg xl:px-cont-xl">
