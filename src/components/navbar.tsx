...
export default function Navbar() {
  ...
  return (
    ...
    >
      <header
        ref={headerRef}
        className="relative top-0 transition-transform z-50 shadow-md bg-white px-largeCont py-7 grid grid-cols-[1fr_auto_1fr] items-center text-main-light underline-offset-2"
      >
        {isLarge ? (
